...
import java.util.*;
 class Ransome<Key, Value> {
    ...
    private void resize(int capacity) {
        Ransome<Key, Value> temp = new Ransome<Key, Value>(capacity);
        for (int i = 0; i < m; i++) {
            if (kys[i] != null) {
    ...
    public static void main(String[] args) {
        Ransome<String, Integer> st = new Ransome<String, Integer>();
